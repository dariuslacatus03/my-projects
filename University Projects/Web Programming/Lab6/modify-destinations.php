    ...
    <div class="row">
      <ul class="list-group" style="margin-top:100px;">
          ...
          while ($row = mysqli_fetch_object($new_result)) {
            echo '<li class="list-group-item">'.$row->name. '<a href="./modify-specific-destination.php?id='.$row->id.'" class="float-end btn btn-danger">Edit</a> </li>';
          }
          ?>
      </ul>
       <ul class="pagination mt-10">
        ...
        for($page = 1; $page<= $number_of_page; $page++) {  
            if($page == $page_selected)
                echo '<li class="page-item active"><a class="page-link" href="./modify-destinations.php?page='.$page.'">'.$page.'</a></li>';
            else
                echo '<li class="page-item"><a class="page-link" href="./modify-destinations.php?page='.$page.'">'.$page.'</a></li>';
        }
        ?>
      </ul>
